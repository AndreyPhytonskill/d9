...
def todo():    
    ...
    name1_user = User.objects.create_user(username = 'username1', email = 'username1@mail.ru', password = 'name1_password')
    ...
    text_article_sport_cinema = """Бег — один из способов передвижения (локомоции) человека и животных; 
    ...
    article_name1 = Post.objects.create(author = name1, post_type = Post.article, title = "Статья Бег", text = text_article_sport_cinema)
    article_name2 = Post.objects.create(author = name2, post_type = Post.article, title = "Статья Дзюдо", text = text_article_sport)
    ...
    PostCategory.objects.create(post = article_name1, category = cat_cinema)
    ...
    comment1 = Comment.objects.create(post = article_name1, user = name2.user, text = "коммент Name2 №1 к статье Name1")
    comment2 = Comment.objects.create(post = article_name2, user = name1.user, text = "коммент Name1 №2 к статье Name2")
    comment3 = Comment.objects.create(post = news_name2, user = name1.user, text = "коммент Name1 №3 к новости Name2")
    comment4 = Comment.objects.create(post = news_name2, user = name2.user, text = "коммент Name2 №4 к новости Name2")
